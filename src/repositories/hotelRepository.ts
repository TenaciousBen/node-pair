...
const data: Hotel[] = [
    {
        id: 1, name: "Cheapo Hotel", starRating: "3.5", pricePerNightPerTraveller: 50, availability: [
    ...
    {
        id: 2, name: "El Average Hotel", starRating: "4", pricePerNightPerTraveller: 75, availability: [
    ...
    {
        id: 3, name: "Pricey Hotel", starRating: "4.5", pricePerNightPerTraveller: 100, availability: [
            { from: "2021-01-01 00:00", to: "2022-01-01 00:00" }
        ]
    },
    {
        id: 4, name: "Fancy Hotel", starRating: "5", pricePerNightPerTraveller: 200, availability: [
